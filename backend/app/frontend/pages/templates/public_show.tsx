...
// The official Sentrel logo (gradient diamond + Instrument Serif wordmark, via
// AppLogo) with an optional mono byline prefix — reused so the brand shows up
// consistently on the page and in any screenshot of it.
